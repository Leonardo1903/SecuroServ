...
return (
    ...
    <section className="w-screen h-fit md:h-screen bg-black py-5">
        ...
        <div className="w-screen flex flex-col md:flex-row justify-around text-white my-5 space-y-4 md:space-y-0">
            <div className="w-[90%] mx-auto md:mx-0 md:w-[25rem] h-[35rem] bg-[#212224] space-y-4 space-x-3 pb-4 rounded-2xl px-3 py-2 hover:w-[26rem] hover:h-[36rem] hover:px-auto">
            ...
            <div className="w-[90%] mx-auto md:mx-0 md:w-[25rem] h-[35rem] bg-[#212224] space-y-4 space-x-3 pb-4 rounded-2xl px-3 py-2 hover:w-[30rem] hover:h-[36rem] hover:px-auto">
