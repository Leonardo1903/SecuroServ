...
return (
    ...
    <section className="w-screen h-screen bg-[#212224] flex flex-col md:flex-row justify-around py-20 items-center" >
        <div className="w-full md:w-[50%] space-y-6">
            <h1 className="text-5xl md:text-7xl text-white">Authenticity Guardians: Your Shield Against Impersonators</h1>
            <h3 className="text-gray-500 text-xl">A trusted destination for finding fake social media profiles</h3>
