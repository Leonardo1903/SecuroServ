        ...
        <div className="w-screen flex flex-col md:flex-row justify-around text-white my-5 space-y-4 md:space-y-0">
          <div className="w-[90%] mx-auto md:mx-0 md:w-[25rem] h-[35rem] bg-[#212224] space-y-4 space-x-3 pb-4 rounded-2xl px-3 py-2  hover:scale-110">
            ...
            <p className="text-xl text-ellipsis">
              Fake profiles may be involved in various forms of online fraud,
              including phishing, Ponzi schemes, and online scams that can lead
              to financial losses.
            </p>
          </div>
          <div className="w-[90%] mx-auto md:mx-0 md:w-[25rem] h-[35rem] bg-[#212224] space-y-4 space-x-3 pb-4 rounded-2xl px-3 py-2 hover:scale-110">
            ...
            <p className="text-xl">
              Fake profiles can be used to manipulate public opinion, influence
              political outcomes, and create artificial trends or viral content.
            </p>
          </div>
          <div className="w-[90%] mx-auto md:mx-0 md:w-[25rem] h-[35rem] bg-[#212224] space-y-4 space-x-3 pb-4 rounded-2xl px-3 py-2 hover:scale-110 ">
            <img
            ...
            <p className="text-xl">
              Negative reviews and feedback can harm a business reputation and
